...
import { Flex, Container, Button, SimpleGrid, Box, Heading, Image, Text, Link, Stack } from '@chakra-ui/react'
  ...
  return (
    <Layout background='white'>
      <Container maxW='container.xl' py={4}>
        <Button leftIcon={<ArrowLeft />} variant='link' sx={{ color: 'black', fontSize: '14px', fontWeight: '400' }}>
              ...
              {() => {
                return (
                  <>
                    ...
                    <Button variant='form' leftIcon={<ArrowRightLine />}>
