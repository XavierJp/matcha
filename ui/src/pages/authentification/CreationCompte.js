...
const Formulaire = () => {
  ...
  const { raison_sociale, adresse, contacts, siret } = location.state?.informationSiret
...
const InformationLegale = () => {
  let location = useLocation()
  const { raison_sociale, uai, adresse, contacts, siret, commune, code_postal } = location.state?.informationSiret

  console.log(location.state.informationSiret)
